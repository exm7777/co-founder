...
- 12 founder skills plus the help router: setup, vision, plan, gauntlet, research, sprint, review, bank, steward, recall, offer, content-engine.
- Personalized business charter and voice file written by setup from a one-question-at-a-time interview.
- Plain markdown business vault in a folder you own: initiatives, decisions, lessons, research, hub notes, the daily baton, and the work queue.
